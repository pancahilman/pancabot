...
cl = LINETCR.LINE()
cl.login(token="Eniaty2zm7nw0Rz5NNJ2.KmYwD0l/UFRmr3Czb6dmWG.qp1Dc6LIRG2kNFLOz5c2+TpoU5H3VNkQOYuZncoXl7E=")
cl.loginResult()

#ki = LINETCR.LINE()
#ki.login(token="EnxqsdaCsInQUyjlSLYe./o2ySL7XsgB54DM2hJgsxG.Yqa42N0dvObqFj9fG/ebFIFcZUnDRm0hYkupkpG3F5I=")
#ki.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token="Ena8t39biaXCz2XprlDa.zliegTJ21B2ZuZFtjExqIG.nQf2jarB+mZCuOJLi44gaGOjbIBhxAuFxQ5FOlJ6urw=")
#ki2.loginResult()
...
Bots=[mid,mid]
owner =["u90cc967742feb9facc47771907a0ccc2"]
admin = ["u90cc967742feb9facc47771907a0ccc2"]
wait = {
    'contact':True,
    'autoJoin':True,
            ...
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  cl.sendText(op.param1, "Mau Invite Siapa Yak ??? \nMaap Yak Di Batalin")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                except:
                  random.choice(KAC).cancelGroupInvitation(op.param1, gMembMids)
                  random.choice(KAC).sendText(op.param1, "Mau Invite Siapa Yak ??? ")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              #if msg.from_ in admin:
                cl.sendText(msg.to, "Setlastpoint")
                try:
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : ✰R~aYyu 👊🍁BOT PROTECT✰||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik 0 dulu aYy\nBaru Ketik 00\nDASAR PIKUN ♪")
#-----------------------------------------------
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"PancaSelfBot Mau Bersih² Group Nih")
                    cl.sendText(msg.to,"Dibersihkan Dulu Ya\n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    msg.contentType = 13
...
#-----------------------------------------------
            ...
            elif msg.text in ["Salam kenal","Salken","Salken semua"]:
                ki.sendText(msg.to,"Mudah2an Betah Yak Di Sini")
                ki.sendText(msg.to,"Jangan lupa Follow Smuleku yak @USIpanca😁😁😁")
#-----------------------------------------------
...
#-----------------------------------------------
      ...
      #-------------Fungsi Chat ----------------
            ...
            elif msg.text in ["Assalamualaikum","Assalamu'alaikum wr. wb.","Assalamu'alaikum"]:
                 quote = ['Waalaikumsalam wr. wb.','وَعَلَيْكُمُ الْسَّــــــــــلاَمُ وَرَحْمَةُ اللَّــــــــــهِ وَبَرَكَــــــــــاتُةُ']
                 psn = random.choice(quote)
                 cl.sendText(msg.to,psn)
    ...
    for zx in range(0,200):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Panca⭐⭐👈\n\n™By ✰PancaSelfBot✰")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId']," ✰PancaSelfBot✰")
                    print "Like"
                except:
                    pass
            else:
