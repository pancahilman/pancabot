...
cl = LINETCR.LINE()
cl.login(token="EnJMnE0erxkwO5QlAjd9.Uo9jMzqKmNxw8wDoMp9DIq.6IKHRYX8LIPlvmOiojVasCoTq2w7e8TeFgVSkHh6HMQ=")
cl.loginResult()
...
Bots=[mid,mid]
owner =["ub8ef499994243275d6f167e98ff5d89"]
admin = ["ub8ef499994243275d6f1674e98ff5d89"]
wait = {
    'contact':True,
    'autoJoin':True,
...
ṡȗƿƿȏяṭєԀ ɞʏ: UNIVERSITY SMULE INDONESIA
        ...
        #-------------Fungsi Jam Update Finish-------------------#
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik 0 dulu Mas Pan\nBaru Ketik 00\nDASAR PIKUN ♪")
#-----------------------------------------------
