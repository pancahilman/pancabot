...
satpam.login(token="EnvkdQ26JuXVZlzS8Rk8.jbo4jH8TS0yphx5LHGdrYa.LdpDMvf8Vl0tnINpPTBZCW1Lx/rDz0qooBDE23vgQWs")
satpam.loginResult()
...
k1.login(token="EnA6XdTVrk3ukF0TvuR9.6NKAKUjMZHMW6q+CYzL8Eq.Igl66rB7bMM6P7eM6OdoM9HO7UsqxsuHPrjxiKxsMyw=")
k1.loginResult()

print "login success Nca"
reload(sys)
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Smid,mid1,"u23bc24c8b799bc32b8771fbd1029ddae"]
admin=["ub8ef499994243275d6f1674e98ff5d89","u23bc24c8b799bc32b8771fbd1029ddae"] 
owner=["ub8ef499994243275d6f1674e98ff5d89","u23bc24c8b799bc32b8771fbd1029ddae"]
wait = {
    'contact':False,
    'autoJoin':True,
...
☆ Panca Shop Online ☆
☆ Panca Self Bot ☆
☆ UNIVERSITY SMULE INDONESIA☆
☆ My Love ☆


Minat? Silahkan PM!
Idline: http://line.me/ti/p/~elvenknight""",
    "lang":"JP",
    ...
    "dblack":False,
    "clock":False,
    "cName":"™PancaBotProtect™ ",
    "cName2":"™PancaBot™ ",
    "cName3":"™PancaBot™ ",
    "cName4":"™PancaBot™ ",
    "cName5":"™PancaBot™ ",
    "cName11":"",
    "cName12":"™Kicker™PancaSelf™ ",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":True,
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Set Last Point")
                try:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Check dulu Bro\nBaru Ketik Cctv\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Masuk","Masuk all","Join all"]:
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye all","Kabur all","Kaboor all"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': "u90cc967742feb9facc47771907a0ccc2"}
                    random.choice(KAC).sendMessage(msg)
                    targets = []
                    for g in gs.members:
        ...
        #-------------Fungsi Spam Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                ki.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                kk.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                cl.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                ki.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                kk.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                cl.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                ...
                kk.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                cl.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!􏿿")
                ki.sendText(msg.to,"P 􀔃􀆶™R~aYyu™ up!����")
                kk.sendText(msg.to,"P 􀔃􀆶Finish up!􏿿")
        #-------------Fungsi Spam Finish---------------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot out","Out all room"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                 gid = cl.getGroupIdsJoined()
 ...
 #-----------------End-----------
                ...
                kk.sendText(msg.to,"Hi buddy ??􀅔Har Har􏿿")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Tukang Bakso On")
                ki.sendText(msg.to,"Tukang Sayur On")
                kk.sendText(msg.to,"Tukang Typo On")
                kc.sendText(msg.to,"Tukang Ngintip On")
                ks.sendText(msg.to,"Tukang Nikung On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'ub8ef499994243275d6f1674e98ff5d89'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
...
#---------------------
        ...
        if op.type == 15:
           if op.param2 in Bots:
              return
           random.choice(KAC).sendText(op.param1, "Baper Kyaknya Tuh Orang :v ")
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == True:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Panca Self Bot⭐⭐👈\n\n™USI™")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == True:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^™PancaSelfBot™^\nStatus Boss udah Kami Like\nOwner Kami :\n™PancaSelfBot™")
                    print "Like"
                except:
                    pass
            else:
